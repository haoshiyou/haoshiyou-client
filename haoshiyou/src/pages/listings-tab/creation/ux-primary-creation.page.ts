...
import {HsyUser} from "../../../loopbacksdk/models/index";
import {HsyUserApi} from "../../../loopbacksdk/services/custom/index";
 ...
 */
@Component({
  selector: 'ux-primary-creation',
  templateUrl: 'ux-primary-creation.page.html',
})
export class UxPrimaryCreationPage implements OnInit {
